        ...
        <header class="flex justify-between items-center mb-10">
            ...
            <div class="flex items-center gap-6">
                ...
                <form action="{{ route('admin.logout') }}" method="POST" class="inline">
                    @csrf
                    <button type="submit" class="bg-red-50 hover:bg-red-100 text-red-600 font-bold text-xs p-3 rounded-2xl transition border border-red-100 uppercase tracking-wider">
                        Logout
                    </button>
                </form>
            </div>
