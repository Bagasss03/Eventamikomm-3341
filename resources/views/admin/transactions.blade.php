            ...
            <tbody class="divide-y border-t">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        ...
                        @else
                            <span class="px-3 py-1 bg-rose-100 text-rose-700 rounded-lg text-xs font-bold uppercase ring-1 ring-rose-200">{{ $transaction->status }}</span>
                        @endif
                    </td>
                ...
                <tr class="hover:bg-slate-50/50 transition text-slate-400">
                    ...
                    <td class="px-8 py-6">
                        <p class="font-bold">Maya Sari (Demo)</p>
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        <p class="font-bold text-slate-800">Budi Santoso (Demo)</p>
