        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div
                ...
                <div class="relative overflow-hidden aspect-[3/4]">
                    <img src="{{ ($event->poster_path && Storage::disk('public')->exists($event->poster_path)) ? asset('storage/' . $event->poster_path) : 'https://placehold.co/400x500?text=' . urlencode($event->title) }}" alt="{{ $event->title }}"
            ...
            <div class="col-span-3 text-center py-20 text-slate-400">
                ...
                <p class="mt-2">Nantikan event seru dari kami!</p>
            </div>
            @endforelse
        </div>
    </section>
